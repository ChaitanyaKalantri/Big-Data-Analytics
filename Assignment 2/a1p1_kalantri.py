...
class MyMapReduce:#[TODO]
    ...
    def partitionFunction(self,k): #[TODO]
        ...
        node = 0
        try:
            node = hash(k) % self.num_reduce_tasks
        except:
            print('Partition Function error')
        return node
    ...
    def runSystem(self): #[TODO]
        ...
        #[DONE]
        print ("namenode_fromR after map tasks complete:")
...
if __name__ == "__main__": #[DONE: Uncomment peices to test]
    ...
    data2 = [('R', [x for x in range(50) if random.random() > 0.5]),
